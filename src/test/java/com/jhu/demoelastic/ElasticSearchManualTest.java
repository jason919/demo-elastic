 ...
 *
 * The following docker command can be used: docker run -d --name es762 -p 9200:9200 -e
...
public class ElasticSearchManualTest {
        ...
        public void setUp() throws UnknownHostException {
                ...
                ClientConfiguration clientConfiguration = ClientConfiguration.builder().connectedTo("129.146.45.190:9200").build();
        ...
        public void givenSearchRequest_whenMatchAll_thenReturnAllResults() throws Exception {
                ...
                List<Person> results = Arrays.stream(searchHits).map(hit -> JSON.parseObject(hit.getSourceAsString(), Person.class)).collect(Collectors.toList());
        ...
        public void givenSearchParameters_thenReturnResults() throws Exception {
                ...
                final List<Person> results = Stream.of(response.getHits().getHits(), response2.getHits().getHits(), response3.getHits().getHits()).flatMap(Arrays::stream)
